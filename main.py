...
async def play_():
        ...
        while not bot.is_closed():
            ...
            await bot.change_presence(status=discord.Status.dnd, activity=discord.Game(name="e!help"))
...
with open(r'C:\Users\golde\OneDrive\Bureau\goldenbot\data\config.json') as f:
    r = json.load(f)
bot.run("NDgxNDg5ODY0NjI2NTM2NDU4.Dq2eng.A0ArdKy0FG_pwy9Gy7u8OUKGis0")
f.close()
